...
def recommend_blended_from_data(users_data, number_of_recommendations=20, save_to_csv=True):
    ...
    # Dynamic fairness filter.
    # With small test data, minimum_user_score can be low,
    # so we relax the filter if it removes everything.
...
def recommend_opposite_personal_from_data(user_data, number_of_recommendations=15):
    ...
    # Lower similarity is better for opposite recommendations.
    # Rating and vote count are small quality boosts.
